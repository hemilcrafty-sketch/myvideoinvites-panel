                                    ...
                                    <tbody>
                                        @foreach ($userArray['users'] as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->id }}</td>
                                                <td>{{ App\Http\Controllers\Utils\HelperController::getUserVideoCount($user->uid) }}
                                                </td>
                                                <td>{{ $user->name }}</td>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            <label style="display: none;">
                                                <input type="checkbox" name="export_all" value="1" {{ request('export_all') == '1' ? 'checked' : '' }}> Export All
                                            </label>
