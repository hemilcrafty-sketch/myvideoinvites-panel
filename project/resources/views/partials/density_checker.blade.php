        ...
        <div>
            ...
            @if (isset($slug))
                ...
                @if (!empty($primary_keyword))
                    <button type="button" class="btn btn-outline-success check-primary-density-btn" id="checkPrimaryKeywordBtn"
                        ...
                        <tbody>
                            @forelse ($changeLog as $log)
                                <tr>
                                    <td>{{ $log->key ?? '' }}</td>
                                    <td>
                                        {!! App\Http\Controllers\Admin\AppBaseController::renderChangeValue($log->key, $log->old) !!}
                                    </td>
                                    <td>
                                        {!! App\Http\Controllers\Admin\AppBaseController::renderChangeValue($log->key, $log->new, $log->old) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
