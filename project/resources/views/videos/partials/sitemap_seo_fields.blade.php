...
@if ($roleManager::isAdminOrSeoManager(Auth::user()->user_type))
    @php
        $noIndexStatus = $no_index ?? 0;
        $isDisabled = $noIndexStatus == 1 ? 'disabled' : '';
    @endphp
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="priority" name="priority"
                    ...
                    value="{{ $priorityDisplay }}" {{ $isDisabled }}>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <h6>Frequency</h6>
                <select id="frequency" class="form-control" name="frequency" {{ $isDisabled }}>
