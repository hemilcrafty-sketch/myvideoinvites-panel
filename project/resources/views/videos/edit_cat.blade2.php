    ...
    <div class="video-category-edit-container">
        <div class="min-height-200px">
            <div class="seo-edit-card">
                ...
                <form method="post" id="dynamic_form" enctype="multipart/form-data" {{ request('preview') ? 'disabled' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="category_title"
                                    value="{{ $datas['cat']->category_title ?? '' }}"
                                    placeholder="e.g., Wedding Invitation Videos">
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        if ("{{ request('preview') }}" == "1") {
            ...
            // Specifically for custom dropbox
            $('#parentCategoryInput').css('pointer-events', 'none');
