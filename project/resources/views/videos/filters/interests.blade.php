                ...
                <div class="row justify-content-between flex-wrap">
                    ...
                    <div class="col-md-8 col-12">
                        @include('partials.filter_form', [
                            'action' => route('show_video_interest'),
                        ])
                    </div>
                </div>
                ...
                <div class="flex-grow-1 overflow-auto">
                    <div class="scroll-wrapper table-responsive tableFixHead" style="max-height: 100%;">
                        <table id="temp_table" class="table table-striped table-bordered mb-0">
                            ...
                            <tbody>
                                @foreach ($interestArray as $style)
                                    @php
                                        $newCategoryIds =
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_title">Add Video Interest</h5>
                ...
                <form method="post" id="submit_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="itemName" name="name"
                            placeholder="Video Interest Name" required />
                    </div>
...
<script>
    function openAddModal() {
        $('#modal_title').text('Add Video Interest');
    ...
    function openEditModal(data) {
        $('#modal_title').text('Edit Video Interest');
    ...
    $('#submit_form').on('submit', function(event) {
        ...
        $.ajax({
            url: 'store_or_update_video_interest',
            type: 'POST',
            data: formData,
            beforeSend: function() {
    ...
    function delete_click(id) {
        ...
        var url = "{{ route('video_interest.delete', ':id') }}";
