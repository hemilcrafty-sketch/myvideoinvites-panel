    ...
    <div class="pd-ltr-10 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="card-box d-flex flex-column" style="height: 94vh; overflow: hidden;">
                <div class="row justify-content-between flex-wrap">
                    ...
                    <div class="col-md-8 col-12">
                        @include('partials.filter_form', [
                            'action' => route('video_religions.index'),
                        ])
                    </div>
                </div>
                ...
                <div class="flex-grow-1 overflow-auto">
                    <div class="scroll-wrapper table-responsive tableFixHead" style="max-height: 100%;">
                        <table id="temp_table" class="table table-striped table-bordered mb-0">
                            ...
                            <tbody>
                                @foreach ($religionArray as $style)
                                    <tr>
                ...
                <hr class="my-1">
                @include('partials.pagination', ['items' => $religionArray])
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_title">Add Video Religion</h5>
                ...
                <form method="post" id="submit_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="itemName" name="name"
                            placeholder="Video Religion Name" required />
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        console.log('Modal element:', $('#add_modal').length);
    });

    function openAddModal() {
        console.log('openAddModal called');
        $('#modal_title').text('Add Video Religion');
        ...
        try {
            ...
            myModal.show();
            console.log('Modal opened with Bootstrap 5 API');
        } catch(e) {
    ...
    function openEditModal(id, name, status, id_name) {
        ...
        $('#modal_title').text('Edit Video Religion');
        ...
        try {
            var myModal = new bootstrap.Modal(document.getElementById('add_modal'));
            myModal.show();
            console.log('Edit modal opened with Bootstrap 5 API');
        } catch(e) {
            console.error('Error opening edit modal:', e);
            if (typeof $.fn.modal !== 'undefined') {
                $('#add_modal').modal('show');
                console.log('Edit modal opened with jQuery');
            }
        }
    }
    ...
    function delete_click(id) {
        ...
        var url = "{{ route('video_religions.destroy', ':id') }}";
