                                ...
                                <div class="widget-data w-100">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <hr>
                                            <div class="details text-left mt-3" style="font-size:14px;">
                                                <p>Base Price : <span class="text-secondary fw-bold">₹
                                                        {{ $value['inr']['base_price'] ?? '-' }}</span>
                                                </p>
                                                <p>Page Price : <span class="text-secondary fw-bold">₹
                                                        {{ $value['inr']['page_price'] ?? '-' }}</span>
                                                </p>
                                                ...
                                                <p>Caricature : <span class="text-secondary fw-bold">₹
                                                        {{ $value['inr']['caricature'] ?? '-' }}</span>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <hr>
...
<div class="modal fade" id="add_Template_Rate_model" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="templateRateForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label class="text-secondary">Caricature rate</label>
                                <input type="number" min="0" class="form-control" id="inrCaricatureRate"
                                    name="caricature" placeholder="Enter value" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label class="text-secondary">Page Price</label>
                                <input type="number" min="0" step="0.01" class="form-control"
                                    id="usdPage" name="usd_page" placeholder="Enter value" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label class="text-secondary">Caricature rate</label>
                                <input type="number" min="0" class="form-control" id="usdCaricatureRate"
                                    name="caricature" placeholder="Enter value" required>
                            </div>
                        </div>
                    </div>
        ...
        $(document).on('click', '.edit-template-rate-btn', function() {
            ...
            $.get(`{{ url('templateRate') }}/${id}/edit`, function(response) {
                if (response) {
                    ...
                    $('#inrAnimation').val(value.inr?.animation || '');
                    $('#inrCaricatureRate').val(value.inr?.caricature || '');
                    ...
                    $('#usdCaricatureRate').val(value.usd?.caricature || '');
        ...
        $('#templateRateForm').on('submit', function(e) {
            ...
            let value = {
                inr: {
                    ...
                    caricature: Number($('#inrCaricatureRate').val()),
                },
                usd: {
                    ...
                    caricature: Number($('#usdCaricatureRate').val()),
                }
            };
