 ...
 */
     ...
     */
         ...
         * @static
         */
        public static function streamDecryptToPath($sourceFile)
        {
                        /** @var \SoareCostin\FileVault\FileVault $instance */
                        return $instance->streamDecryptToPath($sourceFile);
        }
    ...
    namespace Illuminate\Http {use AllowDynamicProperties;
            /**
     *
     *
     */
